...
const getExtractorConfig = (outputFilename: string): IConfigFile => ({
  /**
  ...
  compiler: {
     ...
     */
    tsconfigFilePath: "<projectFolder>/build/tsconfig.json",
    /**
   ...
   * Removing this with reference to migration to API Reports Migration: https://product-fabric.atlassian.net/browse/REL-74
   */
  dtsRollup: {
    /**
     ...
     */
    untrimmedFilePath: `<projectFolder>/${outputFilename}`,
    /**
